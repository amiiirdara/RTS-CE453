...
while tasks_edf or task_queue or current_task:
    ...
    if current_task and current_time == current_task['start'] + current_task['execution']:
...
for task in execution_order:
    ...
    print(f"   Start Time: {task['start']}, Completion Time: {task['completion']}, Lateness: {lateness}")
    print("-" * 50)
